...
public class Texture
{
	...
	public void render(float[] projectionMatrix, float x, float y, float z, float scaleX, float scaleY, float angle, float orientationHorizontal, float orientationVertical, int uMatrixLocation, int uTextureUnitLocation, int aPositionLocation, int aTextureCoordinatesLocation)
	{
