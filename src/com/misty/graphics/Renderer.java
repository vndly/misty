...
public class Renderer implements android.opengl.GLSurfaceView.Renderer
{
	...
	public void render(Texture texture, float x, float y, float z, float scaleX, float scaleY, float angle, float orientationHorizontal, float orientationVertical)
	{
		texture.render(this.projectionMatrix, x, y, z, scaleX, scaleY, angle, orientationHorizontal, orientationVertical, this.uMatrixLocation, this.uTextureUnitLocation, this.aPositionLocation, this.aTextureCoordinatesLocation);
	}
